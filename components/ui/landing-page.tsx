      ...
      <div className="fixed top-0 left-0 w-full h-0.5 bg-gradient-to-r from-border/20 via-border/40 to-border/20 z-50">
        <div
          ...
          style={{
            ...
            filter: 'drop-shadow(0 0 2px rgba(110, 86, 207, 0.5))'
          }}
        />
      </div>
      ...
      {sections.map((section, index) => (
        ...
        >
          <div className={cn(
            ...
            {section.badge && (
              <div className={cn(
                "inline-flex items-center gap-2 px-3 py-1.5 rounded-full border border-primary/30 bg-primary/10 text-primary text-xs sm:text-sm font-medium mb-6 sm:mb-8",
            ...
            <h1 className={cn(
              ...
              {section.subtitle ? (
                <div className="space-y-1 sm:space-y-2">
                  ...
                  <div className="bg-gradient-to-r from-primary via-primary/90 to-primary/70 bg-clip-text text-transparent text-[0.8em] sm:text-[0.85em] font-bold">
                    {section.subtitle}
                  </div>
                </div>
              ) : (
            ...
            <div className={cn(
              "text-muted-foreground leading-relaxed mb-8 sm:mb-10 text-base sm:text-lg lg:text-xl font-light",
              ...
              {index === 0 && (
                <div className="flex flex-wrap items-center gap-3 sm:gap-4 text-xs sm:text-sm text-muted-foreground/60 mt-4 sm:mt-6">
                  ...
                  <div className="flex items-center gap-1.5 sm:gap-2">
                    <div className="w-1 h-1 rounded-full bg-primary animate-pulse" style={{ animationDelay: '1s' }} />
                  ...
                  <button
                    ...
                    className={cn(
                      ...
                      action.variant === 'primary'
                        ...
                        : "border-2 border-border/60 bg-background/50 backdrop-blur-sm hover:bg-accent/10 hover:border-primary/30 text-foreground"
                    )}
...
export default function GlobeScrollDemo() {
  const demoSections = [
    ...
    },
    {
      ...
      description: "Pure human connection through voice.",
    ...
    },
    {
      ...
      description: "Everything designed to protect and connect.",
      align: "left" as const,
      features: [
        { title: "Anonymous", description: "No identity required" },
        { title: "Voice Only", description: "No text, no filters" },
        { title: "Safe Space", description: "Full control always" }
      ]
    },
    {
      id: "cta",
      badge: "Ready?",
      title: "Start Tonight",
      description: "Join thousands of honest conversations.",
      align: "center" as const,
      actions: [
  ...
  return <ScrollGlobe sections={demoSections} className="bg-black" />;
}
